...
export function DataTable<TData, TValue>({
    ...
    const [searchColumn, setSearchColumn] = React.useState<string>(t("page.unit.data_table.columns.name_column_label", "Nama"));
        ...
        <div className='p-3 border rounded-2xl'>
            <div className="flex:col lg:flex justify-between items-center pb-4">
                ...
                <div className="second-row overflow-auto flex justify-start sm:justify-end gap-2 mt-2 lg:mt-0">
                    ...
                    <Can
                        permission={PERMISSIONENUMS.UNIT.DELETE}
                    >
                        <BulkDeleteDialog isDisabled={!(Object.keys(rowSelection).length > 0)}
                            ...
                            units={Object.keys(rowSelection).map(id => ({ id: Number(id) } as Unit))}
                            onBulkDeleteClick={() => {
                                const selectedRows = Object.keys(rowSelection).map(id => ({ id: Number(id) } as Unit));
                    ...
                    <Can
                        permission={PERMISSIONENUMS.UNIT.CREATE}
                    >
