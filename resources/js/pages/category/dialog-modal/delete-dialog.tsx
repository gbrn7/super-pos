...
export function DeleteDialog({ isOpen, onSuccess, category, setOpen }: DeleteDialogProps) {
      ...
      >
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            ...
            variant="destructive" disabled={loading}>{loading ? "Deleting..." : "Delete"}</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog >
  )
