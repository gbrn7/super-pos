...
export function ExportDropdownMenu<TData>({
  ...
  const exportcolumns = [
    ...
    t("page.category.data_table.columns.created_at_column_label", "Tanggal dibuat"),
    t("page.category.data_table.columns.updated_at_column_label", "Tanggal diperbarui"),
  ];
