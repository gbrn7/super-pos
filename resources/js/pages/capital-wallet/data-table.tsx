        ...
        <div className="space-y-4 rounded-2xl border bg-card p-3">
            ...
            <div className="second-row grid grid-cols-1 gap-2 gap-y-3 rounded-md border p-3 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative w-full">
                        ...
                        <Input
                            placeholder={t(
                                'page.capital_wallet.data_table.filters.keyword_placeholder',
                ...
                <div className="space-y-1.5">
                    <Label className="flex items-center gap-1 text-sm font-medium text-muted-foreground">
                        ...
                        {t(
                            'page.capital_wallet.data_table.filters.type_label',
                            'Arah Aliran',
                        )}
                    </Label>
                    <Select
                    ...
                    >
                        <SelectTrigger className="w-full">
                            <SelectValue
                                placeholder={t(
                                    'page.capital_wallet.data_table.filters.type_placeholder',
                                    'Semua Arah',
                                )}
                            />
                        </SelectTrigger>
                ...
                <div className="space-y-1.5">
                    <Label className="flex items-center gap-1 text-sm font-medium text-muted-foreground">
                        ...
                        {t(
                            'page.capital_wallet.data_table.filters.tx_type_label',
                            'Jenis Transaksi',
                        )}
                    </Label>
                    <Select
                    ...
                    >
                        <SelectTrigger className="w-full">
                            <SelectValue
                                placeholder={t(
                                    'page.capital_wallet.data_table.filters.tx_type_placeholder',
                                    'Semua Jenis',
                                )}
                            />
                        </SelectTrigger>
                        <SelectContent>
                            ...
                            <SelectItem value="sales_capital_recovery">
                                {t(
                                    ...
                                    t(
                                        'page.capital_wallet.data_table.filters.tx_sales_recovery',
                                        'Pemulihan Modal',
                                    ),
                                )}
                            </SelectItem>
                ...
                <div className="space-y-1.5">
                    <Label className="flex items-center gap-1 text-sm font-medium text-muted-foreground">
                        ...
                        {t(
                            'page.capital_wallet.data_table.filters.start_date_label',
                            'Mulai',
                        )}
                    </Label>
                    <Popover>
                ...
                <div className="space-y-1.5">
                    <Label className="flex items-center gap-1 text-sm font-medium text-muted-foreground">
                        <Calendar className="h-3.5 w-3.5" />
                        {t(
                            'page.capital_wallet.data_table.filters.end_date_label',
                            'Hingga',
                        )}
                    </Label>
                    <Popover>
            ...
            {isFilterActive && (
                <div className="col-span-full flex flex-wrap items-center gap-1.5 pt-2 text-xs">
                    <span className="text-muted-foreground">
                        {t(
                            'page.capital_wallet.data_table.filters.active_filters',
                            'Filter Aktif:',
                        )}
                    </span>
                    {queryParam.keyword && (
                    ...
                    {queryParam.end_date && (
                        ...
                        >
                            {t(
                                'page.capital_wallet.data_table.filters.end_date_badge_label',
                                'Akhir',
                            )}
                            : {queryParam.end_date}
                            <button
