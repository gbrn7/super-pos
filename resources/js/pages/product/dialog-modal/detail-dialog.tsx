            ...
            <DialogContent showCloseButton={true}>
                <DialogContent className="max-w-170! max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="dialog-body grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t("page.product.dialog_modal.detail_dialog.unit_label", "Nama Satuan")}
                            </p>
                            <p className="mt-1 text-base">{product.unit_name}</p>
                        </div>
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t("page.product.dialog_modal.detail_dialog.category_name_label", "Nama Kategori")}
                            </p>
                            <p className="mt-1 text-base">{product.category_name}</p>
                        </div>
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t("page.product.dialog_modal.detail_dialog.cost_price_label", "Harga Modal")}
                            </p>
                            <p className="mt-1 text-base">{formatRupiah(product.cost_price)}</p>
                        </div>
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t("page.product.dialog_modal.detail_dialog.price_label", "Harga Jual")}
                            </p>
                            <p className="mt-1 text-base">{formatRupiah(product.price)}</p>
                        </div>
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t("page.product.dialog_modal.detail_dialog.barcode_label", "Barcode")}
                            </p>
                            <p className="mt-1 text-base">{product.barcode != '' ? product.barcode : '-'}</p>
                        </div>
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t("page.product.dialog_modal.detail_dialog.stock_label", "Stok")}
                            </p>
                            {product.stock ? (
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t("page.product.dialog_modal.detail_dialog.is_active_label", "Status")}
                            </p>
                            {product.is_active ? (<Badge className="bg-cyan-50 mt-1 text-cyan-700 dark:bg-cyan-950 dark:text-cyan-300">
                                <Check size={184} strokeWidth={2.25} />
                                {
                                    t("page.product.is_active.active", "Aktif")
                                }
                            </Badge>) :
                                (<Badge className="bg-slate-200 text-slate-800 mt-1 dark:bg-slate-800 dark:text-slate-300">
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t("page.product.dialog_modal.detail_dialog.desc_label", "Deskripsi")}
                            </p>
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t("page.product.dialog_modal.detail_dialog.sku_label", "SKU")}
                            </p>
