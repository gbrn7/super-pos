...
export function DataTable<TData, TValue>({
    ...
    const [searchColumn, setSearchColumn] = React.useState<string>(
        t('page.user.data_table.columns.name_column_label', 'Nama'),
    );
                ...
                <div className="flex items-center justify-start gap-2 overflow-auto sm:justify-end lg:mt-0">
                    ...
                    <Can permission={PERMISSIONENUMS.USER.DELETE}>
                        <BulkDeleteDialog
                            ...
                            users={Object.keys(rowSelection).map(
                                (id) => ({ id: Number(id) }) as User,
                            )}
                            onBulkDeleteClick={() => {
                                const selectedRows = Object.keys(
                                    rowSelection,
                                ).map((id) => ({ id: Number(id) }) as User);
                    ...
                    <Can permission={PERMISSIONENUMS.USER.CREATE}>
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        ...
                                        <SelectItem
                                            value={t(
                                                'page.user.data_table.columns.name_column_label',
                                                'Nama',
                                            )}
                                        >
                                            {t(
                                        ...
                                        <SelectItem
                                            value={t(
                                                'page.user.data_table.columns.email_column_label',
                                                'Email',
                                            )}
                                        >
                                            {t(
                                                'component.data_table.search_component.email',
                                                'Email',
                                            )}
                                        </SelectItem>
                                        <SelectItem
                                            value={t(
                                                'page.user.data_table.columns.role_column_label',
                                                'Peran',
                                            )}
                                        >
                                            {t(
                                                'component.data_table.search_component.role',
                                                'Peran',
                                            )}
                                        </SelectItem>
                                    </SelectGroup>
