...
export default function create() {
    ...
    const handleSubmit = async (e: React.SubmitEvent) => {
        ...
        try {
            ...
            const res = await axiosInstance.post<ResponseApi<Role>>(
                storeRole().url,
                formData,
            );
                    ...
                    >
                        <div className="confirm-btn-wrapper flex justify-end gap-2">
                            <Link href={index().url}>
                                <Button type="button" variant="outline">
                                    {t(
                                        'page.role.create.form.cancel_button',
                                        'Batal',
                                    )}
                                </Button>
                            </Link>
                            ...
                            >
                                ...
                                {loading ? (
                                    ...
                                    t(
                                        'page.role.create.form.confirm_button',
                                        'Tambah Peran',
                                    )
                                )}
                            </Button>
                        ...
                        <Field>
                            <label htmlFor="name" className="text-sm">
                                {t(
                                    'page.role.create.form.name_input_label',
                                    'Nama',
                                )}
                            ...
                            <Input
                                ...
                                name="name"
                                placeholder={t(
                                    'page.role.create.form.name_input_placeholder',
                                    'Masukkan nama peran',
                                )}
                                value={formData.name}
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    <Label className="text-sm">
                                        {t(
                                            'page.role.create.form.permissions_input_label',
                                            'Izin',
                                        )}
                                        <span className="text-red-500"> *</span>
                                    </Label>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        >
                                            {t(
                                                'page.role.create.form.check_all_permissions',
                                                'Pilih semua perizinan',
                                            )}
                                        </label>
                                        <p className="mt-0.5 text-sm text-slate-400">
                                            {t(
                                                'page.role.create.form.check_all_permissions_desc',
