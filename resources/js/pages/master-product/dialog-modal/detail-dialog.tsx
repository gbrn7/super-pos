            ...
            <DialogContent showCloseButton={true}>
                <DialogContent className="max-h-[90vh] max-w-170! overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>
                            {t(
                                'page.master_product.dialog_modal.detail_dialog.dialog_title',
                    ...
                    <div className="dialog-body grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t(
                                    'page.master_product.dialog_modal.detail_dialog.name_label',
                                    'Nama',
                                )}
                            </p>
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t(
                                    'page.master_product.dialog_modal.detail_dialog.unit_label',
                                    'Nama Satuan',
                                )}
                            </p>
                            <p className="mt-1 text-base">
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">
                                {t(
                                    'page.master_product.dialog_modal.detail_dialog.category_name_label',
                                    'Nama Kategori',
                                )}
                            </p>
                            <p className="mt-1 text-base">
