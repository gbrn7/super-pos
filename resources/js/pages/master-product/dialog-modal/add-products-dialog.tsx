            ...
            setFormData((prev) => ({
                ...
                price:
                    ...
                    Number(masterProduct.price) !== 0
                        ...
                        : null,
                cost_price:
                    masterProduct.cost_price != null &&
                    Number(masterProduct.cost_price) !== 0
            ...
            <DialogContent className="max-h-[90vh] sm:max-w-4xl overflow-y-auto">
                <form onSubmit={handleSubmit} className="space-y-4">
                    <DialogHeader>
                        <DialogTitle>
                            {t(
                                'page.master_product.dialog_modal.add_products_dialog.dialog_title',
                                'Tambah Produk',
                            )}
                        </DialogTitle>
                        <DialogDescription>
                            {t(
                                'page.master_product.dialog_modal.add_products_dialog.dialog_desc',
                                'Buat produk baru dari master produk',
                            )}
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-3 rounded-lg bg-muted p-4">
                        <h3 className="text-sm font-semibold">
                            {t(
                                'page.master_product.dialog_modal.add_products_dialog.master_product_info',
                                'Informasi Master Produk',
                            )}
                        </h3>
                        <FieldGroup className="grid grid-cols-1 gap-3 md:grid-cols-2">
                            <Field>
                                <label htmlFor="name" className="text-sm">
                                    {t(
                                        'page.master_product.dialog_modal.add_products_dialog.name_label',
                                        'Nama',
                                    )}
                                </label>
                                <Input
                            ...
                            <Field>
                                <label htmlFor="barcode" className="text-sm">
                                    {t(
                                        'page.master_product.dialog_modal.add_products_dialog.barcode_label',
                                        'Barcode',
                                    )}
                                </label>
                                <Input
                    ...
                    <div className="space-y-3">
                        <h3 className="text-sm font-semibold">
                            {t(
                                'page.master_product.dialog_modal.add_products_dialog.product_details',
                                'Detail Produk',
                            )}
                        </h3>
                        <FieldGroup className="grid grid-cols-1 gap-3 md:grid-cols-2">
                            <Field>
                                ...
                                <SearchableSelect
                                    ...
                                    searchPlaceholder={t(
                                        'page.master_product.dialog_modal.add_products_dialog.search_category_placeholder',
                                        'Cari kategori...',
                                    )}
                                    emptyMessage={t(
                                        'page.master_product.dialog_modal.add_products_dialog.no_categories_found',
                            ...
                            <Field>
                                ...
                                <SearchableSelect
                                    ...
                                    searchPlaceholder={t(
                                        'page.master_product.dialog_modal.add_products_dialog.search_unit_placeholder',
                                        'Cari satuan...',
                                    )}
                                    emptyMessage={t(
                                        'page.master_product.dialog_modal.add_products_dialog.no_units_found',
                            ...
                            <Field>
                                ...
                                <Input
                                    ...
                                    type="number"
                                    placeholder={t(
                                        'page.master_product.dialog_modal.add_products_dialog.stock_placeholder',
                            ...
                            <Field>
                                ...
                                <NumericFormat
                                    ...
                                    prefix="Rp "
                                    placeholder={t(
                                        'page.master_product.dialog_modal.add_products_dialog.cost_price_placeholder',
                            ...
                            <Field>
                                ...
                                <NumericFormat
                                    ...
                                    prefix="Rp "
                                    placeholder={t(
                                        'page.master_product.dialog_modal.add_products_dialog.price_placeholder',
                                        'Masukkan harga jual',
                                    )}
                            ...
                            <Field>
                                <label className="text-sm">
                                    {t(
                                        'page.master_product.dialog_modal.add_products_dialog.image_label',
                                        'Gambar',
                                    )}
                                </label>
                                <Input
                        ...
                        <Field>
                            <label htmlFor="desc" className="text-sm">
                                {t(
                                    'page.master_product.dialog_modal.add_products_dialog.desc_label',
                                    'Deskripsi',
                                )}
                            </label>
                            <Textarea
                                ...
                                name="desc"
                                placeholder={t(
                                    'page.master_product.dialog_modal.add_products_dialog.desc_placeholder',
