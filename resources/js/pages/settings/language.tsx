...
export default function Language() {
    ...
    const languages: languageSwitcher[] = [
        {
            value: 'id',
            label: t('page.settings.language.language_options.Indonesia'),
        },
        {
            value: 'en',
            label: t('page.settings.language.language_options.English'),
        },
    ];

    const defaultLang = languages.find((l) => l.value === lang) || languages[0];

    const [languageSelect, setLanguageSelect] =
        useState<languageSwitcher>(defaultLang);
    ...
    return (
        <>
            ...
            <h1 className="sr-only">
                {t('page.settings.language.title', 'Pengaturan bahasa')}
            </h1>
            ...
            <div className="space-y-6">
                <Heading
                    variant="small"
                    title={t(
                        'page.settings.language.title',
                        'Pengaturan bahasa',
                    )}
                    description={t(
                        'page.settings.language.description',
                        'Perbarui pengaturan bahasa Anda',
                    )}
                />
                <div className="flex flex-col gap-2">
                    <label htmlFor="name" className="text-sm">
                        {t('page.settings.language.language_label', 'Bahasa')}
                    </label>
                    <Select
