...
<head>
    <meta charset="UTF-8">
    <title>Laporan Dompet Profit</title>
    <style>
        body {
    ...
    <div class="clearfix">
        <div class="summary-box">
            <table class="summary-table">
                <tr>
                    <td>Total Riwayat:</td>
                    <td class="text-right font-bold">{{ number_format(count($transactions), 0, ',', '.') }}</td>
                </tr>
                <tr>
                ...
                <tr style="border-top: 1px solid #cbd5e1;">
                    ...
                    <td class="text-right font-bold" style="color: #0f172a; font-size: 11px;">Rp {{ number_format($summary['current_balance'] ?? $summary['balance'] ?? 0, 0, ',', '.') }}</td>
                </tr>
            </table>
        </div>
    </div>
